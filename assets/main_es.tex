...
\subsection{La función de onda y las leyes físicas que la gobiernan}

\subsubsection{La ecuación de Schrödinger}
...
Además, la biblioteca HuggingFace Transformers proporciona una referencia
modular para capas de atención, normalizaciones de capa, esquemas de
inicialización y utilidades de entrenamiento eficientes.
