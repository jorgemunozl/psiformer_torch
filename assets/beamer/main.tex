...
\begin{equation*}
W^{Q}, W^{K}, W^{V} \in \mathbb{R}^{n_{\text{embd}}\times n_{\text{embd}}},\qquad
\mathbf{k}_{i}=\mathbf{W}^{k}\mathbf{h}_{i},\;
\mathbf{q}_{i}=\mathbf{W}^{q}\mathbf{h}_{i},\;
\mathbf{v}_{i}=\mathbf{W}^{v}\mathbf{h}_{i}.
\end{equation*}
Stacked per head:
\begin{align}
[\mathbf{q}_{1},\mathbf{q}_{2},\dots ,\mathbf{q}_{n_{h}}] &= \mathbf{q} \\
[\mathbf{k}_{1},\mathbf{k}_{2},\dots ,\mathbf{k}_{n_{h}}] &= \mathbf{k} \\
[\mathbf{v}_{1},\mathbf{v}_{2},\dots ,\mathbf{v}_{n_{h}}] &= \mathbf{v}
\end{align}
In the $i-th$ head:
\begin{equation}
